...
$error2=NULL;
                    if(isset($_POST['btnlogin']))
                    {
                        ...
                        $querry="select * from `team` where `team_email`='$email' && `team_password`='$password'";
    ...
    <div class="container">
                    ...
                    <?php
                        ...
                        ?><br/>
                        <h1 class="text-3xl text-slate-800 font-bold rb">Employee Login! ✨</h1>
                        <!-- Form -->
                        <form method="POST">
                            <div class="ln">
                                <div>
                            ...
                            <div class="flex fg ir">
                                <button class="btn hb xs yo" name="btnlogin" >Login In</button>
                            </div>
                        </form>
                    </div>
    </div>
